...
function HomePage() {
  return (
    <div className="overflow-hidden">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="relative max-w-5xl mx-auto rounded-[2.5rem] overflow-hidden glass-card border border-white/10 p-8 md:p-12">
            <div className="absolute inset-0 bg-gradient-radial-purple opacity-50" />
            <div className="absolute inset-0 bg-gradient-radial-orange opacity-30" />
            <div className="relative grid md:grid-cols-2 gap-10 items-center">
              <div className="relative order-2 md:order-1">
                <span className="inline-block px-3 py-1 rounded-full glass text-xs font-bold tracking-wider text-gradient-brand mb-4 uppercase">
                  قائد المجتمع
                </span>
                <h3 className="text-3xl md:text-4xl font-black mb-3">
                  المهندس <span className="text-gradient-brand">عبدالرحمن</span>
                </h3>
                <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                  مؤسس وقائد مجتمع <span className="text-foreground font-bold">THE 4 SEASON STUDIO</span>،
                  خبرة عميقة في التسويق الرقمي وإدارة المشاريع التقنية. قاد فريقًا متكاملًا لتقديم
                  أكثر من <span className="text-foreground font-bold">1200 مشروع ناجح</span> لعملاء حول العالم.
                </p>
                <div className="flex flex-wrap gap-3">
                  {["إدارة استراتيجية", "تسويق رقمي", "تطوير تقني", "تصميم إبداعي"].map((tag) => (
              ...
              <div className="relative order-1 md:order-2 flex justify-center">
                <div className="absolute inset-0 bg-gradient-brand blur-3xl opacity-40 rounded-full" />
                <div className="relative h-72 w-56 md:h-96 md:w-72 rounded-3xl overflow-hidden border-2 border-white/10 shadow-elegant">
                  <img src={abdulrahmanImg} alt="المهندس عبدالرحمن" className="w-full h-full object-cover" loading="lazy" />
                </div>
              </div>
            </div>
          </div>
