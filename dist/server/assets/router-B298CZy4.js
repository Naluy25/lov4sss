...
const appCss = "/assets/styles-CXi1bkq2.css";
...
function CartProvider({ children }) {
  ...
  const updateDetails = (id, details) => setItems((prev) => prev.map((p) => p.id === id ? { ...p, details } : p));
  const clear = () => setItems([]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    CartContext.Provider,
    {
      value: { items, addItem, removeItem, updateDetails, clear, count: items.length },
      children
    }
  );
}
    ...
    Link,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-gradient-brand blur-xl opacity-60 group-hover:opacity-100 transition-opacity" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-12 w-12 md:h-14 md:w-14 rounded-full bg-gradient-brand flex items-center justify-center shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${s.num} font-black text-white leading-none`, children: "4" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-tight", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${s.text} text-muted-foreground tracking-[0.3em] font-medium`, children: "THE" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base md:text-lg font-extrabold text-gradient-brand tracking-wide", children: "4 SEASON" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${s.text} text-muted-foreground tracking-[0.3em] font-medium`, children: "STUDIO" })
        ] })
      ]
    }
  );
...
function Header() {
  ...
  const [portfolioOpen, setPortfolioOpen] = reactExports.useState(false);
  const { count } = useCart();
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? "glass border-b border-white/5 py-2" : "bg-transparent py-4"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 flex items-center justify-between gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden lg:flex items-center gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "px-4 py-2 rounded-full text-sm font-medium text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1", children: [
                    "أعمالنا",
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-3.5 w-3.5" })
                  ] }),
                  portfolioOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-full right-0 pt-3 min-w-[240px] animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-2xl p-2 border border-white/10 shadow-2xl", children: portfolioLinks.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Link,
                    {
                      to: p.to,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  ...
                  count > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1 h-5 w-5 rounded-full bg-gradient-brand text-white text-xs font-bold flex items-center justify-center animate-scale-in", children: count })
                ]
              }
            ),
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 bg-background/95 backdrop-blur-xl animate-fade-in lg:hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "container mx-auto px-4 mt-8 flex flex-col gap-2", children: [
            navLinks.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: l.to,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 rounded-2xl glass-card", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-semibold mb-3", children: "أعمالنا" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1.5", children: portfolioLinks.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  to: p.to,
                  onClick: () => setOpen(false),
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative mt-32 border-t border-white/5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-radial-purple opacity-40 pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-16 relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-4 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { size: "md" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-md leading-relaxed", children: "منصة إلكترونية متكاملة لخدمات التسويق الرقمي. أكثر من 5000 عميل يثقون بنا لبيع الخدمات الإلكترونية بسهولة وأمان." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 pt-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold mb-4 text-gradient-brand", children: "روابط سريعة" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2.5 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "hover:text-foreground transition-colors", children: "الرئيسية" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/packages", className: "hover:text-foreground transition-colors", children: "الباقات" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/shop", className: "hover:text-foreground transition-colors", children: "شراء خدمة" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/how-to-buy", className: "hover:text-foreground transition-colors", children: "طريقة الشراء" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/testimonials", className: "hover:text-foreground transition-colors", children: "آراء العملاء" }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold mb-4 text-gradient-brand", children: "أعمالنا" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2.5 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/portfolio/web", className: "hover:text-foreground transition-colors", children: "المواقع والمتاجر" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/portfolio/design", className: "hover:text-foreground transition-colors", children: "تصميم ومونتاج" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/portfolio/social", className: "hover:text-foreground transition-colors", children: "سوشيال ميديا" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/portfolio/management", className: "hover:text-foreground transition-colors", children: "إدارة الصفحات" }) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 pt-6 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " THE 4 SEASON STUDIO — جميع الحقوق محفوظة"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "إدارة المهندس ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-brand font-semibold", children: "عبدالرحمن" })
        ] })
      ] })
    ] })
  ] });
...
function AnimatedBackground() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 -z-10 overflow-hidden pointer-events-none", children: [
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-8xl font-black text-gradient-brand", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-2xl font-bold", children: "الصفحة غير موجودة" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "الصفحة التي تبحث عنها غير موجودة أو تم نقلها" }),
...
const Route$a = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "THE 4 SEASON STUDIO — وكالة التسويق الرقمي" },
      { property: "og:description", content: "منصة متكاملة لكل خدمات التسويق الإلكتروني" },
...
const $$splitComponentImporter$9 = () => import("./testimonials-DP5eHNsk.js");
const Route$9 = createFileRoute("/testimonials")({
  head: () => ({
    meta: [{
      title: "آراء العملاء — THE 4 SEASON STUDIO"
    }, {
      name: "description",
      content: "اقرأ آراء وتجارب أكثر من 5000 عميل تعاملوا معنا"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./shop-BwdmAf2n.js");
const Route$8 = createFileRoute("/shop")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "تصفح كافة خدماتنا واختر ما يناسبك. خدمات برمجية، تصميم ومونتاج، سوشيال ميديا، وإدارة صفحات."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./packages-CKRCYNEY.js");
const Route$7 = createFileRoute("/packages")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "خطط تسويق وباقات خدمات متنوعة تناسب جميع احتياجاتك بأسعار رمزية"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./how-to-buy-DFDVIvgm.js");
const Route$6 = createFileRoute("/how-to-buy")({
  head: () => ({
    meta: [{
      title: "طريقة الشراء — THE 4 SEASON STUDIO"
    }, {
      name: "description",
      content: "تعرف على خطوات شراء الخدمات وقواعد الشراء وطرق الدفع المتاحة"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./index-CvBmMXSL.js");
const Route$5 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "وكالة تسويق رقمي متكاملة. أكثر من 5000 عميل يثقون بنا. تصميم مواقع، سوشيال ميديا، تصميم ومونتاج، وإدارة صفحات."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./portfolio.index-BAGZ7gj-.js");
const Route$4 = createFileRoute("/portfolio/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "استعرض أعمالنا في تصميم المواقع، التصميم والمونتاج، السوشيال ميديا، وإدارة الصفحات"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./portfolio.web-BQcH_2Mx.js");
const Route$3 = createFileRoute("/portfolio/web")({
  head: () => ({
    meta: [{
      title: "أعمال المواقع والمتاجر — THE 4 SEASON STUDIO"
    }, {
      name: "description",
      content: "أعمالنا في تصميم وبرمجة المواقع والمتاجر الإلكترونية والمنصات التعليمية"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./portfolio.social-DXqb89c4.js");
const Route$2 = createFileRoute("/portfolio/social")({
  head: () => ({
    meta: [{
      title: "أعمال السوشيال ميديا — THE 4 SEASON STUDIO"
    }, {
      name: "description",
      content: "حملات زيادة المتابعين والتفاعل على جميع منصات السوشيال ميديا"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./portfolio.management-BgmYRbAR.js");
const Route$1 = createFileRoute("/portfolio/management")({
  head: () => ({
    meta: [{
      title: "أعمال إدارة الصفحات — THE 4 SEASON STUDIO"
    }, {
      name: "description",
      content: "إدارة صفحات وحملات إعلانية وهويات بصرية متكاملة"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./portfolio.design-jkArvr0F.js");
const Route2 = createFileRoute("/portfolio/design")({
  head: () => ({
    meta: [{
      title: "أعمال التصميم والمونتاج — THE 4 SEASON STUDIO"
    }, {
      name: "description",
      content: "تصاميم دراسية، لوجوهات، هويات بصرية ومونتاج فيديو"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const TestimonialsRoute = Route$9.update({
  id: "/testimonials",
  path: "/testimonials",
...
const HowToBuyRoute = Route$6.update({
  id: "/how-to-buy",
  path: "/how-to-buy",
  getParentRoute: () => Route$a
});
...
const PortfolioIndexRoute = Route$4.update({
  id: "/portfolio/",
  path: "/portfolio/",
  getParentRoute: () => Route$a
});
const PortfolioWebRoute = Route$3.update({
  id: "/portfolio/web",
  path: "/portfolio/web",
  getParentRoute: () => Route$a
});
const PortfolioSocialRoute = Route$2.update({
  id: "/portfolio/social",
  path: "/portfolio/social",
  getParentRoute: () => Route$a
});
const PortfolioManagementRoute = Route$1.update({
  id: "/portfolio/management",
  path: "/portfolio/management",
  getParentRoute: () => Route$a
});
const PortfolioDesignRoute = Route2.update({
  id: "/portfolio/design",
...
const rootRouteChildren = {
  ...
  ShopRoute,
  TestimonialsRoute,
  PortfolioDesignRoute,
  PortfolioManagementRoute,
  PortfolioSocialRoute,
  PortfolioWebRoute,
  PortfolioIndexRoute
};
